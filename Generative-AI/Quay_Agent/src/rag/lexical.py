...
Measured over the built corpus: 433 chunks, 4876 distinct tokens, and 1624 of
...
they appear in 80 and 79 chunks respectively, so BM25 scores them near zero,
which is correct.

No new dependency: ``rank-bm25`` is not installed and is not needed at this
size. The index is rebuilt from ``data/corpus/`` rather than read back out of
