...
No paper is fetched here. The corpus is Markdown notes carrying their citations in
frontmatter: no PDF loader is declared, so a PDF would be a file nothing can read.
